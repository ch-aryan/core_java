...
class CarTest1 implements Runnable{
    @Override
   public void run() {//see the diff
        try {
            runCar();
    ...
    public void runCar() throws InterruptedException {
        System.out.println(Thread.currentThread().getName() + " has entered to parking slot");
        Thread.sleep(2000);
        synchronized (this) {
